...
-->
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $user['housename'];?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Street</div>
                    <div class="col-lg-9 col-md-8"><?php echo $user['street'];?></div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $user['zip'];?></div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $user['aadhar'];?></div>
                  </div>
...
-->
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="housename" type="text" class="form-control" id="housename" value="<?php echo $user['housename'];?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="street" type="text" class="form-control" id="street" value="<?php echo $user['street'];?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="zip" type="text" class="form-control" id="zip" value="<?php echo $user['zip'];?>">
                      </div>
                    </div>
                    <div class="row mb-3">
...
-->
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="aadhar" type="text" class="form-control" id="aadhar" value="<?php echo $user['aadhar'];?>">
                      </div>
                    </div>
<!--
                    <div class="row mb-3">
                ...
                <div class="tab-pane fade pt-3" id="profile-settings">
                  ...
                  <form>
                    ...
                    <div class="row mb-3">
                      <label for="fname" class="col-md-4 col-lg-3 col-form-label">Email Notifications</label>
                      <div class="col-md-8 col-lg-9">
