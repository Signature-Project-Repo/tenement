            ...
            <div class="card">
              <div class="card-body">
                ...
                <table class="table datatable">
                  ...
                  <tbody>
                    <?php
                    $sql1 = "SELECT b.*, a.services FROM booking b, addservice a WHERE a.serviceid = b.serviceid AND a.email = '$email' AND status IN ('1', '2')";
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                            <?php
                            if ($row['status'] == 1) {
                              echo '<span class="btn btn-warning btn-sm"><i class="bi bi-hourglass"></i>   Payment Pending  </span>';
                            } elseif ($row['status'] == 2) {
                              echo '<a href="php/servicecomplete.php?email=' . $row['email'] . '&serviceid=' . $row['serviceid'] . '&bookingid=' . $row['bookingid'] . '&status=3" class="btn btn-success btn-sm">Complete   <i class="bi bi-patch-check"></i></a>';
                            }
                            ?>
                          </div>
                        </td>
